...
def BuildBootableImage(sourcedir):
  ...
  ramdisk_img.write("\x00"*288)
  img = tempfile.NamedTemporaryFile()
  kernel = tempfile.NamedTemporaryFile()
  kernel.write("\x00"*288)
  kernel.write(open(os.path.join(sourcedir, "kernel"), "rb").read())
  ...
  if os.access(fn, os.F_OK):
    ...
    cmd = ["mkbootimg", "--kernel", kernel.name]
  ...
  return cyanboot + "\x00"*offset + data
